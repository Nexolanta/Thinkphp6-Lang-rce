...
def main():
    ...
    parse.add_option("-u", "--url", dest="Url", type=str, help="输入要检测的url")
    parse.add_option("-f", "--file", dest="FilePath", type=str, help="输入要检测的URL列表")
    parse.add_option("-c", "--choose", dest="choose", default="poc", type=str, help="选择poc检测或exp检测")
    parse.add_option("-r", "--remoteurl", dest="remoteUrl", default=None, type=str, help="输入远程链接")
    parse.add_option("-v", help="软件版本")
